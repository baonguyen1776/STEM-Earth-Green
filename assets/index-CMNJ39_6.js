...
`;class Ce{_mesh;_material;_pollutionLevel=0;_cleanColor;_pollutedColor;_baseIntensity;_baseThickness;_isDisposed=!1;constructor(t={}){const e=M.radius;this._baseThickness=t.thickness??1.12;const i=e*this._baseThickness,s=M.widthSegments;this._baseIntensity=t.intensity??.8,this._pollutionLevel=t.pollutionLevel??0,this._cleanColor=new l(g.atmosphere.clean),this._pollutedColor=new l(g.atmosphere.polluted);const n=new E(i,s,s);this._material=new O({vertexShader:we,fragmentShader:Me,uniforms:{glowColor:{value:this._cleanColor.clone()},innerColor:{value:new l(8965375)},intensity:{value:this._baseIntensity},power:{value:2.5},thickness:{value:0},pollutionLevel:{value:0}},side:B,transparent:!0,blending:j,depthWrite:!1}),this._mesh=new T(n,this._material),this._mesh.name="atmosphere",this.setPollutionLevel(this._pollutionLevel)}get mesh(){return this._mesh}get material(){return this._material}get pollutionLevel(){return this._pollutionLevel}get isDisposed(){return this._isDisposed}setPollutionLevel(t){if(this._isDisposed)return;this._pollutionLevel=_(t,0,100);const e=this._pollutionLevel/100,i=new l;i.lerpColors(this._cleanColor,this._pollutedColor,e),this._material.uniforms.glowColor.value=i;const s=new l(8965375),n=new l(3815994),a=new l;a.lerpColors(s,n,e),this._material.uniforms.innerColor.value=a;const r=c(this._baseIntensity,this._baseIntensity*1.8,e);this._material.uniforms.intensity.value=r;const m=c(0,1,Math.pow(e,1.5));this._material.uniforms.thickness.value=m;const y=c(2.5,1.5,e);this._material.uniforms.power.value=y,this._material.uniforms.pollutionLevel.value=this._pollutionLevel;const C=c(1,1.15,Math.pow(e,2));this._mesh.scale.setScalar(C),this._material.needsUpdate=!0}setIntensity(t){this._isDisposed||(this._material.uniforms.intensity.value=_(t,0,2))}setPower(t){this._isDisposed||(this._material.uniforms.power.value=_(t,1,10))}setColor(t){this._isDisposed||(this._material.uniforms.glowColor.value=new l(t))}show(){this._mesh.visible=!0}hide(){this._mesh.visible=!1}toggle(){return this._mesh.visible=!this._mesh.visible,this._mesh.visible}dispose(){this._isDisposed||(this._mesh.geometry.dispose(),this._material.dispose(),this._isDisposed=!0)}}class Le{_group;_mesh;_material=null;_shaderMaterial=null;_useDayNightShader;_clouds=null;_atmosphere=null;_textures;_pollutionLevel=0;_autoRotate;_rotationSpeed;_isDisposed=!1;constructor(t={}){this._pollutionLevel=t.pollutionLevel??0,this._autoRotate=t.autoRotate??!0,this._rotationSpeed=t.rotationSpeed??le.rotationSpeed,this._useDayNightShader=t.useDayNightShader??!0,this._group=new X,this._group.name="earth-system";const e=new E(M.radius,M.widthSegments,M.heightSegments);let i;this._useDayNightShader?(this._shaderMaterial=new _e({pollutionLevel:this._pollutionLevel,dayMap:t.textures?.dayMap??void 0,nightMap:t.textures?.nightMap??void 0,normalMap:t.textures?.normalMap??void 0,specularMap:t.textures?.specularMap??void 0}),i=this._shaderMaterial.material):(this._material=new Q({...t.materialOptions,pollutionLevel:this._pollutionLevel,textures:t.textures}),i=this._material.material),this._mesh=new T(e,i),this._mesh.name="earth",this._group.add(this._mesh),t.enableClouds!==!1&&(this._clouds=new be({...t.cloudOptions,pollutionLevel:this._pollutionLevel,cleanCloudTexture:t.textures?.cloudsMap??void 0,pollutedCloudTexture:t.textures?.pollutedCloudMap??void 0}),this._group.add(this._clouds.mesh)),t.enableAtmosphere!==!1&&(this._atmosphere=new Ce({...t.atmosphereOptions,pollutionLevel:this._pollutionLevel}),this._group.add(this._atmosphere.mesh)),this._textures=fe()}get group(){return this._group}get mesh(){return this._mesh}get material(){return this._material}get shaderMaterial(){return this._shaderMaterial}get clouds(){return this._clouds}get atmosphere(){return this._atmosphere}get pollutionLevel(){return this._pollutionLevel}get rotation(){return this._mesh.rotation}get isDisposed(){return this._isDisposed}async loadTextures(t){const e=await this._textures.loadAll(t);this.applyTextures(e)}applyTextures(t){this._isDisposed||(this._useDayNightShader&&this._shaderMaterial?this._shaderMaterial.setTextures({dayMap:t.dayMap??void 0,nightMap:t.nightMap??void 0,normalMap:t.normalMap??void 0,specularMap:t.specularMap??void 0,cloudsMap:t.cloudsMap??void 0,pollutedDayMap:t.pollutedDayMap??void 0}):this._material&&(this._material.applyTextures(t),t.nightMap&&this._material.setNightMap(t.nightMap)),this._clouds&&this._clouds.setTextures({cleanCloudMap:t.cloudsMap??void 0,pollutedCloudMap:t.pollutedCloudMap??void 0}))}setPollutionLevel(t){this._isDisposed||(this._pollutionLevel=_(t,0,100),this._shaderMaterial&&this._shaderMaterial.setPollutionLevel(this._pollutionLevel),this._material&&this._material.setPollutionLevel(this._pollutionLevel),this._clouds?.setPollutionLevel(this._pollutionLevel),this._atmosphere?.setPollutionLevel(this._pollutionLevel))}update(t){this._isDisposed||(this._autoRotate&&(this._mesh.rotation.y+=this._rotationSpeed*t),this._clouds?.update(t))}setRotation(t,e,i){this._mesh.rotation.set(t,e,i)}setRotationSpeed(t){this._rotationSpeed=t}setAutoRotate(t){this._autoRotate=t}setCloudsVisible(t){this._clouds&&(t?this._clouds.show():this._clouds.hide())}setAtmosphereVisible(t){this._atmosphere&&(t?this._atmosphere.show():this._atmosphere.hide())}setPosition(t,e,i){this._group.position.set(t,e,i)}setScale(t){this._group.scale.setScalar(t)}dispose(){this._isDisposed||(this._material?.dispose(),this._shaderMaterial?.dispose(),this._clouds?.dispose(),this._atmosphere?.dispose(),this._mesh.geometry.dispose(),this._group.parent&&this._group.parent.remove(this._group),this._isDisposed=!0)}}class xe{_mesh;_geometry;_material;_count;_twinkle;_originalSizes=null;_twinkleSpeed=2;_time=0;_isDisposed=!1;_sunGroup=null;_sunCoreMesh=null;_sunGlowMesh=null;_sunRaysMesh=null;constructor(t={}){this._count=t.count??2500;const e=t.minDistance??50,i=t.maxDistance??300,s=t.size??.8,n=t.color??16777215;this._twinkle=t.twinkle??!1;const a=new Float32Array(this._count*3),r=new Float32Array(this._count),m=new Float32Array(this._count);for(let L=0;L<this._count;L++){const F=Math.random()*Math.PI*2,U=Math.acos(2*Math.random()-1),V=e+Math.random()*(i-e),vt=V*Math.sin(U)*Math.cos(F),bt=V*Math.sin(U)*Math.sin(F),wt=V*Math.cos(U);a[L*3]=vt,a[L*3+1]=bt,a[L*3+2]=wt,r[L]=s*(.4+Math.random()*.6),m[L]=.3+Math.random()*.5}this._geometry=new dt,this._geometry.setAttribute("position",new k(a,3)),this._geometry.setAttribute("size",new k(r,1)),this._geometry.setAttribute("opacity",new k(m,1)),this._twinkle&&(this._originalSizes=new Float32Array(r));const y=document.createElement("canvas");y.width=64,y.height=64;const C=y.getContext("2d"),w=C.createRadialGradient(32,32,0,32,32,32);w.addColorStop(0,"rgba(255, 255, 255, 1)"),w.addColorStop(.5,"rgba(255, 255, 255, 0.8)"),w.addColorStop(1,"rgba(255, 255, 255, 0)"),C.fillStyle=w,C.fillRect(0,0,64,64);const A=new At(y);this._material=new mt({color:new l(n),size:1,sizeAttenuation:!0,map:A,transparent:!0,opacity:1,blending:j,depthWrite:!1}),this._mesh=new _t(this._geometry,this._material),this._mesh.name="starfield",(t.enableSun??!0)&&this._createSunGlow(t.sunPosition??{x:40,y:25,z:60})}_createSunGlow(t){this._sunGroup=new X,this._sunGroup.name="sunGlow";const e=new E(3,32,32),i=new It({color:16777181,transparent:!0,opacity:1});this._sunCoreMesh=new T(e,i),this._sunGroup.add(this._sunCoreMesh);const s=new E(6,32,32),n=new O({uniforms:{glowColor:{value:new l(16768358)},intensity:{value:3.5}},vertexShader:`
        varying vec3 vNormal;
        void main() {
          vNormal = normalize(normalMatrix * normal);
          gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
      ...
      `,transparent:!0,blending:j,side:B,depthWrite:!1});this._sunGlowMesh=new T(s,n),this._sunGroup.add(this._sunGlowMesh);const a=new E(30,32,32),r=new O({uniforms:{glowColor:{value:new l(16764040)},intensity:{value:3.5}},vertexShader:`
        varying vec3 vNormal;
        void main() {
          vNormal = normalize(normalMatrix * normal);
          gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
      ...
      `,transparent:!0,blending:j,side:B,depthWrite:!1});this._sunRaysMesh=new T(a,r),this._sunGroup.add(this._sunRaysMesh),this._sunGroup.position.set(t.x,t.y,t.z-10),this._mesh.add(this._sunGroup)}get mesh(){return this._mesh}get count(){return this._count}get isDisposed(){return this._isDisposed}update(t){if(this._isDisposed||!this._twinkle||!this._originalSizes)return;this._time+=t*this._twinkleSpeed;const e=this._geometry.attributes.size,i=e.array;for(let s=0;s<this._count;s++){const n=s*.01,a=.7+.3*Math.sin(this._time+n);i[s]=this._originalSizes[s]*a}e.needsUpdate=!0}setColor(t){this._isDisposed||(this._material.color=new l(t))}setOpacity(t){this._isDisposed||(this._material.opacity=_(t,0,1))}setSize(t){this._isDisposed||(this._material.size=t)}setTwinkle(t){if(this._twinkle=t,t&&!this._originalSizes){const e=this._geometry.attributes.size;this._originalSizes=new Float32Array(e.array)}}show(){this._mesh.visible=!0}hide(){this._mesh.visible=!1}toggle(){return this._mesh.visible=!this._mesh.visible,this._mesh.visible}dispose(){this._isDisposed||(this._geometry.dispose(),this._material.dispose(),this._sunCoreMesh&&(this._sunCoreMesh.geometry.dispose(),this._sunCoreMesh.material.dispose()),this._sunGlowMesh&&(this._sunGlowMesh.geometry.dispose(),this._sunGlowMesh.material.dispose()),this._sunRaysMesh&&(this._sunRaysMesh.geometry.dispose(),this._sunRaysMesh.material.dispose()),this._isDisposed=!0)}get sunGroup(){return this._sunGroup}}class De{_mesh;_geometry;_material;_particles=[];_maxParticles;_pollutionLevel=0;_earthRadius;_spawnTimer=0;_activeCount=0;_isDisposed=!1;constructor(t={}){this._maxParticles=t.maxParticles??500,this._pollutionLevel=t.pollutionLevel??0,this._earthRadius=t.earthRadius??M.radius;const e=t.color??g.effects.smoke;for(let a=0;a<this._maxParticles;a++)this._particles.push({position:new u,velocity:new u,life:0,maxLife:0,size:0,opacity:0});const i=new Float32Array(this._maxParticles*3),s=new Float32Array(this._maxParticles),n=new Float32Array(this._maxParticles);this._geometry=new dt,this._geometry.setAttribute("position",new k(i,3)),this._geometry.setAttribute("size",new k(s,1)),this._geometry.setAttribute("opacity",new k(n,1)),this._material=new mt({color:new l(e),size:.1,sizeAttenuation:!0,transparent:!0,opacity:.5,blending:pt,depthWrite:!1}),this._mesh=new _t(this._geometry,this._material),this._mesh.name="smoke-system",this._mesh.frustumCulled=!1}get mesh(){return this._mesh}get activeCount(){return this._activeCount}get pollutionLevel(){return this._pollutionLevel}get isDisposed(){return this._isDisposed}update(t){this._isDisposed||(this.spawnParticles(t),this.updateParticles(t),this.updateGeometry())}setPollutionLevel(t){if(this._isDisposed)return;this._pollutionLevel=_(t,0,100);const e=new l(g.effects.smoke),i=new l(g.effects.smokeDense),s=this._pollutionLevel/100;this._material.color.lerpColors(e,i,s);const n=c(.3,.8,s);this._material.opacity=n;const a=Math.max(0,(this._pollutionLevel-80)/20),r=c(.1,.25,a);this._material.size=r}setColor(t){this._isDisposed||(this._material.color=new l(t))}show(){this._mesh.visible=!0}hide(){this._mesh.visible=!1}clear(){for(const t of this._particles)t.life=0;this._activeCount=0,this.updateGeometry()}dispose(){this._isDisposed||(this._geometry.dispose(),this._material.dispose(),this._isDisposed=!0)}spawnParticles(t){if(this._pollutionLevel<30)return;let e;if(this._pollutionLevel<=80){const s=(this._pollutionLevel-30)/50;e=c(5,30,s)}else{const s=(this._pollutionLevel-80)/20;e=30+Math.pow(s,2)*120}this._spawnTimer+=t;const i=1/e;for(;this._spawnTimer>=i;)this._spawnTimer-=i,this.spawnParticle()}spawnParticle(){const t=this._particles.find(r=>r.life<=0);if(!t)return;const e=Math.random()*Math.PI*2,i=Math.acos(2*Math.random()-1),s=this._earthRadius*1.05;t.position.set(s*Math.sin(i)*Math.cos(e),s*Math.sin(i)*Math.sin(e),s*Math.cos(i));const n=t.position.clone().normalize(),a=new u(0,1,0);t.velocity.copy(n).multiplyScalar(.2).add(a.multiplyScalar(.1+Math.random()*.1)),t.velocity.x+=(Math.random()-.5)*.1,t.velocity.y+=(Math.random()-.5)*.1,t.velocity.z+=(Math.random()-.5)*.1,t.maxLife=2+Math.random()*2,t.life=t.maxLife,t.size=.05+Math.random()*.1,t.opacity=.3+Math.random()*.3,this._activeCount++}updateParticles(t){this._activeCount=0;for(const e of this._particles){if(e.life<=0||(e.life-=t,e.life<=0))continue;this._activeCount++,e.position.add(e.velocity.clone().multiplyScalar(t)),e.velocity.multiplyScalar(.99),e.size*=1.01;const i=e.life/e.maxLife;e.opacity=c(0,.5,i)}}updateGeometry(){const t=this._geometry.attributes.position,e=t.array;for(let i=0;i<this._particles.length;i++){const s=this._particles[i];s.life>0?(e[i*3]=s.position.x,e[i*3+1]=s.position.y,e[i*3+2]=s.position.z):(e[i*3]=0,e[i*3+1]=-1e3,e[i*3+2]=0)}t.needsUpdate=!0}}class Se{_group;_meshes;_particles=[];_maxParticles;_pollutionLevel=0;_earthRadius;_orbitHeight;_spawnTimer=0;_activeCount=0;_dummy;_isDisposed=!1;constructor(t={}){this._maxParticles=t.maxParticles??200,this._pollutionLevel=t.pollutionLevel??0,this._earthRadius=t.earthRadius??M.radius,this._orbitHeight=t.orbitHeight??.2,this._group=new X,this._group.name="trash-system",this._dummy=new zt;for(let e=0;e<this._maxParticles;e++)this._particles.push({position:new u,velocity:new u,rotation:new Ot,rotationSpeed:new u,scale:1,active:!1});this._meshes=this.createTrashMeshes(),this.updateGeometry()}get mesh(){return this._group}get activeCount(){return this._activeCount}get pollutionLevel(){return this._pollutionLevel}get isDisposed(){return this._isDisposed}update(t){this._isDisposed||(this.spawnParticles(t),this.updateParticles(t),this.updateGeometry())}setPollutionLevel(t){this._isDisposed||(this._pollutionLevel=_(t,0,100),this._pollutionLevel<60&&this.reduceParticles())}show(){this._group.visible=!0}hide(){this._group.visible=!1}clear(){for(const t of this._particles)t.active=!1;this._activeCount=0,this.updateGeometry()}dispose(){if(!this._isDisposed){for(const t of this._meshes)t.geometry.dispose(),t.material instanceof Nt&&t.material.dispose();this._isDisposed=!0}}createTrashMeshes(){const t=[],e=new Ft(.02,.04,.02),i=new W({color:g.effects.plasticTrash,roughness:.8}),s=new nt(e,i,Math.floor(this._maxParticles/2));s.name="trash-boxes",t.push(s),this._group.add(s);const n=new Ht(.015,0),a=new W({color:g.effects.metalTrash,roughness:.6}),r=new nt(n,a,Math.floor(this._maxParticles/2));return r.name="trash-spheres",t.push(r),this._group.add(r),t}spawnParticles(t){if(this._pollutionLevel<40)return;let e;if(this._pollutionLevel<=80){const s=(this._pollutionLevel-40)/40;e=c(2,15,s)}else{const s=(this._pollutionLevel-80)/20;e=15+Math.pow(s,1.8)*45}this._spawnTimer+=t;const i=1/e;for(;this._spawnTimer>=i;)this._spawnTimer-=i,this.spawnParticle()}spawnParticle(){const t=this._particles.find(F=>!F.active);if(!t)return;const e=Math.random()*Math.PI*2,i=Math.acos(2*Math.random()-1),s=Math.max(0,(this._pollutionLevel-80)/20),n=c(.3,.8,s),a=this._earthRadius+this._orbitHeight+Math.random()*n;t.position.set(a*Math.sin(i)*Math.cos(e),a*Math.sin(i)*Math.sin(e),a*Math.cos(i));const r=t.position.clone().normalize(),m=new u().crossVectors(r,new u(0,1,0)).normalize();m.length()<.01&&m.crossVectors(r,new u(1,0,0)).normalize();const C=c(.05,.12,s)+Math.random()*.05;t.velocity.copy(m).multiplyScalar(C);const w=c(.02,.06,s);t.velocity.add(r.multiplyScalar(-w+Math.random()*w*2)),t.rotation.set(Math.random()*Math.PI*2,Math.random()*Math.PI*2,Math.random()*Math.PI*2);const A=c(2,4,s);t.rotationSpeed.set((Math.random()-.5)*A,(Math.random()-.5)*A,(Math.random()-.5)*A);const tt=c(.5,.8,s),L=c(1.5,2.5,s);t.scale=tt+Math.random()*L,t.active=!0,this._activeCount++}updateParticles(t){this._activeCount=0;for(const e of this._particles){if(!e.active)continue;this._activeCount++,e.position.add(e.velocity.clone().multiplyScalar(t)),e.rotation.x+=e.rotationSpeed.x*t,e.rotation.y+=e.rotationSpeed.y*t,e.rotation.z+=e.rotationSpeed.z*t;const i=e.position.length();(i>this._earthRadius*2||i<this._earthRadius*.9)&&(e.active=!1)}}reduceParticles(){const t=this._pollutionLevel/60,e=Math.floor(c(0,this._maxParticles*.3,t));let i=this._activeCount-e;for(const s of this._particles){if(i<=0)break;s.active&&(s.active=!1,i--)}}updateGeometry(){const t=Math.floor(this._maxParticles/2);let e=0,i=0;for(let s=0;s<this._particles.length;s++){const n=this._particles[s],a=s<t?0:1,r=this._meshes[a],m=a===0?e++:i++;n.active?(this._dummy.position.copy(n.position),this._dummy.rotation.copy(n.rotation),this._dummy.scale.setScalar(n.scale)):(this._dummy.position.set(0,-1e3,0),this._dummy.scale.setScalar(0)),this._dummy.updateMatrix(),r.setMatrixAt(m,this._dummy.matrix)}for(const s of this._meshes)s.instanceMatrix.needsUpdate=!0}}class Pe{_container;_sliderContainer;_slider;_label=null;_value;_min;_max;_onChange;_labelFormatter;_isDisposed=!1;constructor(t={}){this._container=this.resolveContainer(t.container),this._min=t.min??0,this._max=t.max??100,this._value=t.initialValue??0,this._onChange=t.onChange??null,this._labelFormatter=t.labelFormatter??(e=>`${Math.round(e)}%`),this._sliderContainer=this.createSliderContainer(),this._slider=this.createSlider(t.step??1),t.showLabel!==!1&&(this._label=this.createLabel()),this._sliderContainer.appendChild(this._slider),this._label&&this._sliderContainer.appendChild(this._label),this._container.appendChild(this._sliderContainer),this.setValue(this._value),this.bindEvents()}get value(){return this._value}get element(){return this._sliderContainer}get isDisposed(){return this._isDisposed}setValue(t,e=!0){this._isDisposed||(this._value=_(t,this._min,this._max),this._slider.value=String(this._value),this._label&&(this._label.textContent=this._labelFormatter(this._value)),this.updateSliderGradient(),e&&this._onChange&&this._onChange(this._value))}setOnChange(t){this._onChange=t}enable(){this._isDisposed||(this._slider.disabled=!1,this._sliderContainer.style.opacity="1",this._sliderContainer.style.pointerEvents="auto")}disable(){this._isDisposed||(this._slider.disabled=!0,this._sliderContainer.style.opacity="0.5",this._sliderContainer.style.pointerEvents="none")}show(){this._isDisposed||(this._sliderContainer.style.display="flex")}hide(){this._isDisposed||(this._sliderContainer.style.display="none")}dispose(){this._isDisposed||(this._slider.removeEventListener("input",this.handleInput),this._sliderContainer.parentNode&&this._sliderContainer.parentNode.removeChild(this._sliderContainer),this._isDisposed=!0)}resolveContainer(t){if(!t)return document.body;if(typeof t=="string"){const e=document.querySelector(t);return e||(console.warn(`Container not found: ${t}, using body`),document.body)}return t}createSliderContainer(){const t=document.createElement("div");return t.className="pollution-slider-container",t.style.cssText=`
      position: fixed;
      bottom: 40px;
      left: 50%;
    ...
    `,document.head.appendChild(e)}bindEvents(){this.handleStart=this.handleStart.bind(this),this._button.addEventListener("click",this.handleStart)}handleStart=()=>{this._button.disabled=!0,this._button.textContent="Đang tải...",this._onStart&&this._onStart(),this._autoHide&&this.hide()}}class Ie{_cameraManager;_timeline=null;_duration;_startDistance;_endDistance;_ease;_onComplete;_onUpdate;_isPlaying=!1;_isCompleted=!1;_isDisposed=!1;constructor(t){this._cameraManager=t.cameraManager,this._duration=t.duration??3,this._startDistance=t.startDistance??20,this._endDistance=t.endDistance??this._cameraManager.position.z,this._ease=t.ease??"power2.out",this._onComplete=t.onComplete??null,this._onUpdate=t.onUpdate??null}get isPlaying(){return this._isPlaying}get isCompleted(){return this._isCompleted}get isDisposed(){return this._isDisposed}get progress(){return this._timeline?this._timeline.progress():0}setStartPosition(){this._isDisposed||(this._cameraManager.setPosition(0,0,this._startDistance),this._cameraManager.setTarget(0,0,0))}play(){return this._isDisposed||this._isPlaying||this._isCompleted?Promise.resolve():new Promise(t=>{this._isPlaying=!0,this._cameraManager.setPosition(0,0,this._startDistance),this._cameraManager.setTarget(0,0,0),this._timeline=jt.timeline({onComplete:()=>{this._isPlaying=!1,this._isCompleted=!0,this._cameraManager.setTarget(0,0,0),this._cameraManager.enableControls(),this._onComplete&&this._onComplete(),t()},onUpdate:()=>{this._onUpdate&&this._timeline&&this._onUpdate(this._timeline.progress())}}),this._cameraManager.disableControls();const e=this._cameraManager.positionTarget;this._timeline.to(e,{z:this._endDistance,duration:this._duration,ease:this._ease})})}skip(){this._isDisposed||this._isCompleted||(this._timeline&&(this._timeline.kill(),this._timeline=null),this._cameraManager.setPosition(0,0,this._endDistance),this._cameraManager.enableControls(),this._isPlaying=!1,this._isCompleted=!0,this._onComplete&&this._onComplete())}pause(){this._timeline&&this._isPlaying&&this._timeline.pause()}resume(){this._timeline&&this._isPlaying&&this._timeline.resume()}reset(){this._isDisposed||(this._timeline&&(this._timeline.kill(),this._timeline=null),this._isPlaying=!1,this._isCompleted=!1,this.setStartPosition(),this._cameraManager.disableControls())}setOnComplete(t){this._onComplete=t}setOnUpdate(t){this._onUpdate=t}dispose(){this._isDisposed||(this._timeline&&(this._timeline.kill(),this._timeline=null),this._isDisposed=!0)}}function ze(o){const t=N(o),e=Te(t),i=Ee[t];return{level:t,value:o,normalizedValue:ft(o),label:e.label,description:e.description,range:{min:e.min,max:e.max},effects:{showSmoke:i.showSmoke,trashDensity:i.trashDensity,oceanOpacity:i.oceanOpacity,showForests:i.showForests}}}function Oe(o,t){const e=N(o),i=N(t);return e!==i}function Ne(o){return ft(o)}function Fe(o){const t=[];return typeof o!="number"||isNaN(o)?(t.push("Value is not a number"),{valid:!1,value:NaN,errors:t}):(o<0&&t.push("Value is below minimum (0)"),o>100&&t.push("Value exceeds maximum (100)"),isFinite(o)||t.push("Value must be finite"),{valid:t.length===0,value:o,errors:t})}class J{_pollutionLevel=0;_rotation=0;_scale=1;_listeners=new Set;_pollutionHistory=[];MAX_HISTORY_SIZE=100;constructor(t=0){this.setPollution(t,{silent:!0})}getPollutionLevel(){return this._pollutionLevel}getNormalizedPollution(){return this._pollutionLevel/100}getPollutionSeverity(){return Ne(this._pollutionLevel)}getPollutionInfo(){return ze(this._pollutionLevel)}getPollutionHistory(){return[...this._pollutionHistory]}setPollution(t,e={}){const{silent:i=!1,skipValidator:s=!1}=e;if(!s){const r=Fe(t);if(!r.valid)throw new Error(`Invalid pollution value: ${r.errors.join(", ")}`)}const n=_(t,0,100);if(n===this._pollutionLevel)return;const a=this.getSnapshot();this._pollutionLevel=n,this._pollutionHistory.push(n),this._pollutionHistory.length>this.MAX_HISTORY_SIZE&&this._pollutionHistory.shift(),i||this.emitChange("pollution_changed",a)}incrementPollution(t){const e=this._pollutionLevel+t;return this.setPollution(e),this._pollutionLevel}resetPollution(){this.setPollution(0)}getRotation(){return this._rotation}setRotation(t,e={}){const{silent:i=!1}=e;if(t===this._rotation)return;const s=this.getSnapshot();this._rotation=t,i||this.emitChange("rotation_changed",s)}incrementRotation(t){return this.setRotation(this._rotation+t),this._rotation}resetRotation(){this.setRotation(0)}getScale(){return this._scale}setScale(t,e={}){const{silent:i=!1}=e;if(t<=0)throw new Error("Scale must be greater than 0");if(t===this._scale)return;const s=this.getSnapshot();this._scale=t,i||this.emitChange("scale_changed",s)}resetScale(){this.setScale(1)}getSnapshot(){return Object.freeze({pollutionLevel:this._pollutionLevel,rotation:this._rotation,scale:this._scale})}restoreSnapshot(t,e={}){const{silent:i=!1}=e,s=this.getSnapshot();this._pollutionLevel=_(t.pollutionLevel,0,100),this._rotation=t.rotation,this._scale=t.scale,i||this.emitChange("state_reset",s)}addListener(t){return this._listeners.add(t),()=>{this._listeners.delete(t)}}removeListener(t){this._listeners.delete(t)}removeAllListeners(){this._listeners.clear()}emitChange(t,e){const i={type:t,oldState:e,newState:this.getSnapshot(),timestamp:Date.now()};this._listeners.forEach(s=>{try{s(i)}catch(n){console.error("Error in state change listener:",n)}})}hasPollutionLevelChanged(){if(this._pollutionHistory.length<2)return!1;const t=this._pollutionHistory[this._pollutionHistory.length-1],e=this._pollutionHistory[this._pollutionHistory.length-2];return Oe(e,t)}toJSON(){return JSON.stringify({pollutionLevel:this._pollutionLevel,rotation:this._rotation,scale:this._scale,history:this._pollutionHistory,timestamp:Date.now()})}fromJSON(t,e={}){try{const i=JSON.parse(t);this.restoreSnapshot({pollutionLevel:i.pollutionLevel??0,rotation:i.rotation??0,scale:i.scale??1},e),Array.isArray(i.history)&&(this._pollutionHistory=i.history)}catch(i){throw new Error(`Failed to parse state JSON: ${i}`)}}clone(){const t=new J(this._pollutionLevel);return t._rotation=this._rotation,t._scale=this._scale,t._pollutionHistory=[...this._pollutionHistory],t}toString(){const t=this.getPollutionInfo();return`EarthState { pollution: ${this._pollutionLevel}% (${t.label}), rotation: ${this._rotation.toFixed(2)}, scale: ${this._scale.toFixed(2)} }`}}class He{renderer;sceneManager;cameraManager;animationLoop;earth;starfield;smokeSystem;trashSystem;slider;infoPanel;introScreen;introController;earthState;_cameraCentered=!1;async init(){try{this.setupContainer(),this.initCore(),await this.initEarth(),this.initEffects(),this.initState(),this.initUI(),this.setupEventHandlers(),this.animationLoop.start(),console.log("🌍 Trái Đất Xanh initialized successfully!")}catch(t){console.error("Failed to initialize application:",t),this.showError("Không thể khởi tạo ứng dụng. Vui lòng tải lại trang.")}}setupContainer(){const t=document.querySelector("#app");if(!t)throw new Error("App container not found");t.innerHTML="",t.style.cssText=`
      width: 100vw;
      height: 100vh;
      margin: 0;
      padding: 0;
      overflow: hidden;
    `}initCore(){this.renderer=new Gt({container:"#app"}),this.sceneManager=new Vt({backgroundColor:0});const t=new ct(16755268,.4,150);t.position.set(40,25,60),this.sceneManager.scene.add(t),this.cameraManager=new ae({domElement:this.renderer.domElement}),this.animationLoop=new re}async initEarth(){this.earth=new Le({pollutionLevel:0,enableClouds:!0,enableAtmosphere:!0,autoRotate:!0}),this.sceneManager.add(this.earth.group,"earth"),this.earth.loadTextures(t=>{console.log(`Loading textures: ${t.percentage}%`)}).catch(t=>{console.warn("Some textures failed to load:",t)})}initEffects(){this.starfield=new xe({count:5e3,twinkle:!0}),this.sceneManager.add(this.starfield.mesh,"starfield"),this.smokeSystem=new De({pollutionLevel:0}),this.sceneManager.add(this.smokeSystem.mesh,"smoke"),this.trashSystem=new Se({pollutionLevel:0}),this.sceneManager.add(this.trashSystem.mesh,"trash")}initState(){this.earthState=new J,this.earthState.addListener(t=>{this.onPollutionChange(t.newState.pollutionLevel)})}initUI(){this.introScreen=new Ae({title:"Trái Đất Xanh",subtitle:"Hai Tương Lai",buttonText:"Khám Phá",onStart:()=>this.startExperience()}),this.introScreen.show(),this.introController=new Ie({cameraManager:this.cameraManager,duration:3,startDistance:50,endDistance:z.z,onComplete:()=>this.onIntroComplete()}),this.slider=new Pe({initialValue:0,onChange:t=>{this.earthState.setPollution(t)}}),this.slider.disable(),this.infoPanel=new Re({position:"top-right",initialValue:0}),this.infoPanel.hide()}setupEventHandlers(){this.animationLoop.add("main",t=>{this._cameraCentered||(this.centerCamera(),this._cameraCentered=!0),this.earth.update(t),this.starfield.update(t),this.smokeSystem.update(t),this.trashSystem.update(t),this.cameraManager.update(),this.renderer.render(this.sceneManager.scene,this.cameraManager.camera)}),window.addEventListener("resize",()=>{this.renderer.updateSize(),this.cameraManager.updateAspect(window.innerWidth/window.innerHeight)}),window.addEventListener("keydown",t=>{t.key==="Escape"&&this.introController.skip()})}centerCamera(){const t=z;this.cameraManager.setPosition(t.x,t.y,t.z),this.cameraManager.setTarget(0,0,0),this.earth.setPosition(0,0,0),console.log("🎥 Camera position:",this.cameraManager.camera.position),console.log("🎯 Camera target:",this.cameraManager.getTarget()),console.log("🌍 Earth position:",this.earth.group.position),console.log("📐 Canvas size:",this.renderer.size),console.log("📏 Aspect ratio:",this.cameraManager.camera.aspect)}startExperience(){this.introController.play()}onIntroComplete(){this.slider.enable(),this.infoPanel.show()}onPollutionChange(t){this.earth.setPollutionLevel(t),this.smokeSystem.setPollutionLevel(t),this.trashSystem.setPollutionLevel(t),this.infoPanel.update(t)}showError(t){const e=document.querySelector("#app");e&&(e.innerHTML=`
        <div style="
          display: flex;
          align-items: center;
          justify-content: center;
      ...
      `)}dispose(){this.animationLoop.stop(),this.earth.dispose(),this.starfield.dispose(),this.smokeSystem.dispose(),this.trashSystem.dispose(),ye(),this.slider.dispose(),this.infoPanel.dispose(),this.introScreen.dispose(),this.introController.dispose(),this.cameraManager.dispose(),this.sceneManager.dispose(),this.renderer.dispose(),console.log("🌍 Application disposed")}}console.log("🌍 Starting STEM Earth Green application...");const yt=new He;yt.init().catch(o=>{console.error("💥 Failed to initialize app:",o),document.body.innerHTML=`
    <div style="color: white; padding: 20px; background: red;">
      <h1>Error Loading Application</h1>
      <p>${o.message}</p>
      <p>Check console for details</p>
    </div>
  `});window.addEventListener("beforeunload",()=>{yt.dispose()});
